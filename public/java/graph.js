...
function xhrLoad() {
  ...
  document.getElementById("temptext").innerHTML = dbdata[5].temp;
  document.getElementById("heighttext").innerHTML = 1;
  document.getElementById("pressuretext").innerHTML = 1;
